...
public class PmsSkuInfo implements Serializable {
  ...
  @Column String skuDesc;

  @Column String catalog3Id;

  @Column String skuDefaultImg;

  @Transient List<PmsSkuImage> pmsSkuImageList;

  @Transient List<PmsSkuAttrValue> pmsSkuAttrValueList;

  @Transient List<PmsSkuSaleAttrValue> pmsSkuSaleAttrValueList;
